...
export const tasksList = () => (
  <List actions={<ListActions />} filters={ResourceFilters}>
    <DatagridConfigurable>
      ...
      <BooleanField source="enemyTransformationDetection" />
      <BooleanField source="spotEnemies" />
      <EditButton />
    </DatagridConfigurable>
  </List>
);
  ...
  <Edit title={<tasksTitle />}>
    <SimpleForm>
      <Grid container rowSpacing={1} columnSpacing={{ xs: 1, sm: 2, md: 5 }}>
        ...
        <Grid item xs={4}>
          <BooleanInput source="enemyTransformationDetection" />
        </Grid>
        <Grid item xs={4}>
          <BooleanInput source="spotEnemies" />
        </Grid>
      </Grid>
    </SimpleForm>
  </Edit>
